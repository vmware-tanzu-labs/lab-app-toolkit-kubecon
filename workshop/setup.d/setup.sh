...
# Create kpack configmap to be able to relocate images before kpack installs
# This is to parallelize operations and make setup faster
...
## Relocate stack and store; Clone git repos
