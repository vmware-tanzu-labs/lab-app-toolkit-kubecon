...
# Wait for CRDs for SecretGen controller to be installed. Can handle not waiting
# for SecretGen operator itself to be deployed.

STATUS=1
ATTEMPTS=0
ROLLOUT_STATUS_CMD="kubectl get crd/secretexports.secretgen.carvel.dev"
