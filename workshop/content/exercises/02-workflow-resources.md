...
```terminal:execute
command: kubectl get GitRepository app -o yaml > ~/exercises/my-first-workload-step-1-source.yaml
```
...
For convenience, export the resource configuration and status details to a file.
```terminal:execute
command: kubectl get imgs app -o yaml > ~/exercises/my-first-workload-step-2-image.yaml
```
...
For convenience, export the resource configuration and status details to a file.
```terminal:execute
command: kubectl get kservice app -o yaml > ~/exercises/my-first-workload-step-3-app.yaml
```
